...
from agents.hate_speech_agent import hate_speech_agent, hate_speech_agent_with_tools
...
from node.db_save import save_moderation_result
...
builder.add_node(node="hate_speech_agent_with_tools", action=hate_speech_agent_with_tools)
...
builder.add_edge(start_key="manager_agent", end_key="db_save")
builder.add_edge(start_key="db_save", end_key=END)
